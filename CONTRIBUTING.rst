...
Welcome to ``data-science`` contributor's guide.
...
If you experience bugs or general issues with ``data-science``, please have a look
...
You can help improve ``data-science`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``data-science`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``data-science``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n data-science python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/data-science.git
    cd data-science
...
#. Install |pre-commit|_::
   ...
   ``data-science`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/data-science
.. _issue tracker: https://github.com/<USERNAME>/data-science/issues
.. <-- end -->
